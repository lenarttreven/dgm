...
if __name__ == '__main__':
    ...
    my_times = [jnp.linspace(0, 1, 10, dtype=jnp.float32) for _ in range(num_trajectories)]
    my_test_times = [jnp.linspace(0, 1, 100, dtype=jnp.float32) for _ in range(num_trajectories)]

    points_x = jnp.linspace(-1, 1, num_x_points) * 5
    points_y = jnp.linspace(-1, 1, num_y_points) * 5
    points_z = jnp.linspace(-1, 1, num_z_points) * 5
